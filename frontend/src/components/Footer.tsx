...
// You'll need to define this navigation object in your project
const navigation = {
sale: [
    { name: "Trending", href: "#" },
    { name: "My Orders", href: "#" },
...
return (
    ...
    <div>
        ...
        <img src={`${process.env.PUBLIC_URL}/images/logo.svg`}alt="HPay" className="h-auto w-auto max-w-[250px]"/>
